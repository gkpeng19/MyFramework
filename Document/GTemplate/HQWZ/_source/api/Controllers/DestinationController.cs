...
namespace HQWZ.Controllers
{
    ...
    {		
		...
		public JsonResult LoadDestinations(*SearchEntityType* se, int page_g, int psize_g)
        {
		...
		public JsonResult SaveDestination(*EntityType* entity)
        {
            if (entity.ID == 0)
            {
                #region 维护新增数据
		...
		public long DeletePanel(*EntityType* entity)
        {
