...
namespace HQWZ.Controllers
{
    public class ArticleController : Controller
    {
		...
		public JsonResult LoadArticleList(*SearchEntityType* se, int page_g, int psize_g)
        {
		...
		public JsonResult SaveArticle(*EntityType* entity)
        {
            if (entity.ID == 0)
            {
                #region 维护新增数据
		...
		public long DeleteArticle(*EntityType* entity)
        {
