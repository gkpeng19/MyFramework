...
namespace HQWZ.Controllers
{
    public class AgenterController : Controller
    {
		...
		public JsonResult LoadAgenterList(*SearchEntityType* se, int page_g, int psize_g)
        {
		...
		public JsonResult SaveAgenter(*EntityType* entity)
        {
            if (entity.ID == 0)
            {
                #region 维护新增数据
		...
		public long DeleteAgenter(*EntityType* entity)
        {
