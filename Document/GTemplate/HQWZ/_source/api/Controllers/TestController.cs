...
namespace HQWZ.Controllers
{
    public class ItemController : Controller
    {
		...
		public JsonResult GetItemList(*SearchEntityType* se, int page_g, int psize_g)
        {
		...
		public JsonResult SaveItem(*EntityType* entity)
        {
            if (entity.ID == 0)
            {
                #region 维护新增数据
		...
		public long DeleteItem(*EntityType* entity)
        {
